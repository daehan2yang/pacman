...
GA_FILENAME = os.path.join(os.path.dirname(__file__), "..", "Train", "checkpoints", "ga", "ga_best_genes_final.npy")
...
Pinky_directions = [
    ...
    [0,  15,  3], [15,   0,  3], [0,  15,  3], [15,   0,  3],
    [0,  -15, 15], [-15,  0,  7], [0,  15,  3], [-15,   0, 19],
    [0,  -15, 11], [15,   0,  9]
]

# Blinky:
Blinky_directions = [
    [0, -15,  4], [15,   0,  9], [0,  15, 11], [15,   0,  3],
